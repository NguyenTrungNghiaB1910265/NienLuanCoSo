                        ...
                        <div class="panel-body">
                            ...
                            <div class="position-center">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{$edit_value->category_name}}" class="form-control"  onkeyup="ChangeToSlug();" name="category_product_name"  id="slug">
                                </div>
                                <!-- <div class="form-group">
                                    <label for="exampleInputPass">Slug</label>
