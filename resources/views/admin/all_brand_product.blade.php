        ...
        <tbody>
            ...
            <tr>
                ...
                <td><span class="text-ellipsis">
                    <?php if($brand_pro->brand_status==1) {?>
                ...
                <a href="{{URL::to('/delete-brand-product/'.$brand_pro->brand_id)}}" onclick="return confirm('Bạn có chắc muốn xóa danh mục này?')" class="active styling-edit" ui-toggle-class="">
