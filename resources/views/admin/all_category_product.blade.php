      ...
      <table class="table table-striped b-t b-light">
        ...
        <tbody>
            ...
            <tr>
                ...
                <a href="{{URL::to('/delete-category-product/'.$cate_pro->category_id)}}" onclick="return confirm('Bạn có chắc muốn xóa danh mục này?')" class="active styling-edit" ui-toggle-class="">
